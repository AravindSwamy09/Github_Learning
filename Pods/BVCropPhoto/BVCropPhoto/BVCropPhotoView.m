...
- (void)setupZoomScale {
    ...
    CGFloat offsetX = ceilf(self.frame.size.width / 2 - self.cropSize.width / 2);
    CGFloat offsetY = ceilf(self.frame.size.height / 2 - self.cropSize.height / 2);
...
- (void)setMaximumZoomScale:(CGFloat)maximumZoomScale {
    _maximumZoomScale = maximumZoomScale > 0 ? maximumZoomScale : 1;
